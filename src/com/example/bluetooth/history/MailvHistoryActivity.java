...
public class MailvHistoryActivity extends AbActivity {
	
	
	  private  List<HistoryXueYa>  getData() {
			FinalDb db = FinalDb.create(MailvHistoryActivity.this);
	...
	public void clear_notes(View v){
	    ...
	    Dialog dialog = new AlertDialog.Builder(this).setIcon(
	    	     ...
	    	     "已清除脉率和血压数据").setPositiveButton("确定",new OnClickListener() {
	  ...
	  private void refresh() {  
	      finish();  
	      Intent intent = new Intent(MailvHistoryActivity.this, MailvHistoryActivity.class);  
    ...
    public void onCreate(Bundle savedInstanceState) {
	    ...
	    //临界线
	    double[] limit = new double[]{100,60};
